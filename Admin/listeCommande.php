                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    <?php foreach ($res as $r) { ?>
                                        <tr>
                                            <th scope="row">
                                                <?php echo $r['idCommande']; ?>
                                            </th>
                                            <td>
                                                <?php echo $r['nomC'] . " " . $r['prenomC']; ?>
                                            </td>
                                            <td>
                                                <?php echo $r['emailC']; ?>
                                            </td>
                                            ...
                                            <td>
                                                <?php echo $r['codePostal']; ?>
                                            </td>
                                            <td>
                                                <?php echo $r['modePaiement']; ?>
                                            </td>
                                            <td>
                                                <?php echo $r['nomCarte']; ?>
                                            </td>
                                            <td>
                                                <?php echo $r['numeroCarte']; ?>
                                            </td>
                                            <td>
                                                <?php echo $r['codeCarte']; ?>
                                            </td>
                                            <td>
                                                <?php echo $r['produitsQuantites']; ?>
                                            </td>
                                            <td>
                                                <?php echo $r['totalFinal']; ?>
                                            </td>
                                            <td>
    <button value="<?php echo $r['idCommande']; ?>" class="btn btn-success">Valider</button>
</td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
