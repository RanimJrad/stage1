...
$ReadSql = "SELECT idPiece ,nomPiece, refPiece, marquePiece, quantite, marqueVoiture, modeleVoiture, prix, nomCategorie 
            FROM piece 
            INNER JOIN categorie ON piece.codeCategorie = categorie.codeCategorie";
                                ...
                                <tbody>
                                    <?php foreach ($res as $r) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $r['marquePiece']; ?>
                                            </td>
                                            <td>
                                                <?php echo $r['refPiece']; ?>
                                            </td>
                                            <td>
                                                <?php echo $r['nomCategorie']; ?>
                                            </td>
                                            <td>
                                                <?php echo $r['prix']; ?>
                                            </td>
                                            ...
                                            <td>
                                                <?php echo $r['marqueVoiture']; ?>
                                            </td>
                                            <td>
                                                <?php echo $r['modeleVoiture']; ?>
                                            </td>
                                            <td>
                                                <a href="modifierProduit.php?idPiece=<?php echo $r['idPiece']; ?>" class="m-2">
                                                    <i class="fa fa-edit fa-2x"></i>
                                                </a>
                                                <i class="fa fa-trash fa-2x red-icon" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModal<?php echo $r['idPiece']; ?>">

                                                </i>

                                                <div class="modal fade" id="exampleModal<?php echo $r['idPiece']; ?>"
                                                    role="dialog">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-body">
                                                                <p>Etes vous sur de vouloir supprimer cette piece ?</p>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-primary"
                                                                    data-bs-dismiss="modal">Annuler</button>
                                                                <a href="supprimerProduit.php?idPiece=<?php echo $r['idPiece']; ?>">
