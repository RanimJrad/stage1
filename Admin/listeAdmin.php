...
$ReadSql = "SELECT * FROM utilisateur where  rolee='Admin'";
                                ...
                                <tbody>
                                    <?php foreach ($res as $r) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $r['dateDeNaissance']; ?>
                                            </td>
                                            <td>
                                                <a href="modifierAdmin.php?idUtilisateur=<?php echo $r['idUtilisateur']; ?>"
                                                    class="m-2">
                                                    <i class="fa fa-edit fa-2x"></i>
                                                </a>
                                                <i class="fa fa-trash fa-2x red-icon" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModal<?php echo $r['idUtilisateur']; ?>">

                                                </i>

                                                <div class="modal fade" id="exampleModal<?php echo $r['idUtilisateur']; ?>"
                                                    role="dialog">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-body">
                                                                <p>Etes vous sur de vouloir supprimer cette Administrateur ?
                                                                </p>
                                                            </div>
                                                            <div class="modal-footer">
                                                                ...
                                                                <a
                                                                    href="supprimerAdmin.php?idUtilisateur=<?php echo $r['idUtilisateur']; ?>">
